        ...
        <section id="hero" className="w-full bg-slate-300">
            <div className="py-44 sm:py-[230px] container-section font-poppins">
                <div className="relative z-30 flex flex-col items-center justify-center text-center gap-8">
                    <h1 className="text-white text-6xl sm:text-7xl font-poppins font-semibold tracking-wide drop-shadow">
                        PeaceApp
                    </h1>
                    <p className="text-slate-100 font-thin tracking-wide text-3xl sm:text-2xl leading-loose drop-shadow">
